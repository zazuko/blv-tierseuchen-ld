...
curl -u ${FSVO_USERNAME}:${FSVO_PASSWORD_TEST} -X POST --data timeout=1000000 --data-urlencode update@sparql/rdf-data-cube-meta-hacklive.rq https://stardog-test.cluster.ldbar.ch/lindas/update
